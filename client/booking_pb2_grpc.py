...
class BookingStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBookingsOfShowtime = channel.unary_stream(
                ...
                request_serializer=common__pb2.ShowtimeData.SerializeToString,
                response_deserializer=booking__pb2.BookingData.FromString,
                _registered_method=True)
...
def add_BookingServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBookingsOfShowtime': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=common__pb2.ShowtimeData.FromString,
                    response_serializer=booking__pb2.BookingData.SerializeToString,
            ),
...
class Booking(object):
    ...
    def GetBookingsOfShowtime(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/Booking/GetBookingsOfShowtime',
            common__pb2.ShowtimeData.SerializeToString,
            booking__pb2.BookingData.FromString,
            options,
            channel_credentials,
            insecure,
